...
BEGIN
    ...
    WHERE id_tournoianime = id_tournoi
      AND ((id_anime1 = id_1 AND id_anime2 = id_2));
    UPDATE AffrontementAnime
    SET vote_anime1 = vote_2,
        vote_anime2 = vote_1
    WHERE id_tournoianime = id_tournoi
      AND ((id_anime1 = id_2 AND id_anime2 = id_1));
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    ...
    WHERE id_tournoimanga = id_tournoi
      AND ((id_manga1 = id_1 AND id_manga2 = id_2));
    UPDATE AffrontementManga
    SET vote_manga1 = vote_2,
        vote_manga2 = vote_1
    WHERE id_tournoimanga = id_tournoi
      AND ((id_manga1 = id_2 AND id_manga2 = id_1));
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    ...
    WHERE id_tournoipersonnage = id_tournoi
      AND ((id_personnage1 = id_1 AND id_personnage2 = id_2));
    UPDATE AffrontementPersonnage
    SET vote_personnage1 = vote_2,
        vote_personnage2 = vote_1
    WHERE id_tournoipersonnage = id_tournoi
      AND ((id_personnage1 = id_2 AND id_personnage2 = id_1));
END;
$$ LANGUAGE plpgsql;
